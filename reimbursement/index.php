...
<html>
<head>
<link rel="stylesheet" type="text/css" href="exchequer.css">
<title>Exchequer Reimbursement</title>
...
<form  name= "exchequer" id="commentForm" enctype="multipart/form-data" action="send.php" method="POST" >
	...
	<img src="dinner_sample.jpg" alt="Sample Dinner Picture" id="dinner_sample" height="50%">
